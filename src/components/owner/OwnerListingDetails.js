...
export default function OwnerListingDetails(props) {
    const classes = useStyles();

    const totalSpacesListElements = [];
    props.totalSpaces.map(currentSpace => totalSpacesListElements.push(<li className={classes.detailsContent}>{currentSpace}</li>));
    ...
    return (
        ...
        {/* Sidebar */}
        <OwnerSidebarCustomLinks editListingLink={props.editListingLink}/>
        ...
        <main className={classes.content}>
            ...
            <div className={classes.marginLeftAndRight} style={{display: "flex", justifyContent: "center", marginTop: "1%", marginBottom: "5%"}}>
