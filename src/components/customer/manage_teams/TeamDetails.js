        ...
        <div className={classes.root}>
            ...
            <main className={classes.content}>
                ...
                <div style={{padding: "30px", textAlign: "center",}}>
                    ...
                    <div>
                        <h3>This is the invitation code:</h3>
                    </div>
                    <div>
                        <i><h4>qwerty123456789</h4></i>
                    </div>
                    <br/>
                    <Button color="primary" variant="contained" type="submit" size="large" onClick={event =>  window.location.href='/manage_team_requests'}>
                        Manage Requests
                    </Button>
                </div>
